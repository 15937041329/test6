package com.test.demo.qrcode.tools;
...
public class QRCodeUtil {
	    ...
	    public static String zxingCodeCreate(String content,String path,Integer size, String logoPath) {
	        try {
				...
				// 生成二维码全路径 --- 生成规则： path\年月日\随机数.jpg
				String pathName = path+datePath + "/"+num+".jpg";
	            //生成二维码存放文件
	            ...
	            String urlPath = "http://www.jdsm.jdvker.com/QRCode/"+datePath + "/"+num+".jpg";
	            return urlPath;
	        } catch (IOException e) {
	            e.printStackTrace();
	            return null;
